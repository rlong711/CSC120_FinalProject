...
public class Game {
    ...
    public Game(String playerName, int health){
        this.playerName = playerName; 
        this.health = health; 
         
    }

    //public void introduction(String choiceOne, Scanner intro){
        //try{
            //if(choiceOne == "yes"){
   ...
   // }
    ...
    public static void main(String args[]){
        ...
        System.out.println("Hello and Welcome! Please enter your name so we can get started."); 
        String playerName = intro.nextLine();
        ...
        System.out.println("Hello " + playerName + "! You have woken up with a note in your hand on the beach. It tells you that there is a treasure to be found! Do you want to go look for that treasure right now?"); 
