...
public class Gameplay {
    ...
    public Gameplay(String avatarName, int health){
    ...
    public static void main(String args[]) {
        Gameplay Raley = new Gameplay("Raley", 3); 
        Raley.introduction();
